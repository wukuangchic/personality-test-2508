...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('introHeading').textContent = UI.introHeading[LANG];
  document.getElementById('introP1').textContent = UI.introP1[LANG];
  document.getElementById('introP2').textContent = UI.introP2[LANG];
  document.getElementById('usageHeading').textContent = UI.usageHeading[LANG];
  document.getElementById('usageP1').textContent = UI.usageP1[LANG];
  document.getElementById('usageP2').textContent = UI.usageP2[LANG];
